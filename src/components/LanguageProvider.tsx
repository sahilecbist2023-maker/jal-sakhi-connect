...
const translations = {
  en: {
    ...
    "technician.scheduleTitle": "Set Pump Schedule",
    "technician.scheduleDesc": "Configure automatic pump operation times",
    "technician.division": "Division",
    "technician.selectDivision": "Select Division",
    "technician.startTime": "Start Time",
    "technician.endTime": "End Time",
    "technician.save": "Save Schedule",
    "technician.cancel": "Cancel",
    "technician.emergencyStopTitle": "Emergency Stop All Pumps",
    "technician.emergencyStopDesc": "This will immediately stop all running pumps across all divisions. Are you sure?",
    "technician.confirmStop": "Yes, Stop All Pumps",
    "technician.scheduleSuccess": "Schedule saved successfully",
    "technician.emergencyStopSuccess": "All pumps stopped successfully",
  ...
  hi: {
    ...
    "technician.scheduleTitle": "पंप शेड्यूल सेट करें",
    "technician.scheduleDesc": "स्वचालित पंप संचालन समय कॉन्फ़िगर करें",
    "technician.division": "डिवीजन",
    "technician.selectDivision": "डिवीजन चुनें",
    "technician.startTime": "शुरू समय",
    "technician.endTime": "समाप्ति समय",
    "technician.save": "शेड्यूल सहेजें",
    "technician.cancel": "रद्द करें",
    "technician.emergencyStopTitle": "सभी पंप आपातकालीन बंद करें",
    "technician.emergencyStopDesc": "यह सभी डिवीजनों में चल रहे सभी पंपों को तुरंत बंद कर देगा। क्या आप सुनिश्चित हैं?",
    "technician.confirmStop": "हाँ, सभी पंप बंद करें",
    "technician.scheduleSuccess": "शेड्यूल सफलतापूर्वक सहेजा गया",
    "technician.emergencyStopSuccess": "सभी पंप सफलतापूर्वक बंद हो गए",
